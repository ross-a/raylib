...
typedef void (*TraceLogCallbackNoVa)(int logType, const char *text);
...
RLAPI void BeginPrintf(void);                                     // Setup printf from shaders
RLAPI void EndPrintf(void);                                       // End printf from shaders
...
RLAPI void SetTraceLogCallbackNoVa(TraceLogCallbackNoVa callback);// Set a trace log callback to enable custom logging
...
RLAPI ModelAnimation *LoadModelAnimations(Model *model, const char *fileName, int *animsCount);                       // Load model animations from file
RLAPI void UpdateModelAnimation(Model model, ModelAnimation anim, int frame);                           // Update model animation pose
RLAPI void UpdateModelBones(Model model, ModelAnimation anim, int frame);                               // Update model animation pose
RLAPI void ResetBones();
